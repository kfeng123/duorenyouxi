...
util.createPlayer=function(x,y,img,frame,id,GAME){
	...
	role.animations.add('right',[6,7,8],40,true);
	role.animations.add('left',[3,4,5],40,true);
	role.animations.add('up',[9,10,11],40,true);
	role.animations.add('down',[0,1,2],40,true);
